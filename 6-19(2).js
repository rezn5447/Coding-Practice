...
//solution 
numbers.map((num, index) => (num * 2) * index);
...
//solution
// It cannot be shortened because it's more than one expression returing 

function includesR(list){
  return list.some((dev) => dev.firstName.includes('R') && dev.language === 'JavaScript');
}
includesR(list1);
includesR(list2);
